...
async function handleEvent(event) {
  ...
  if (message === '1' || message === 'a') {
    commandUrl = 'http://<192.160.1.5>/16/on'; // 控制設備打開
  } else if (message === '0' || message === 'b') {
    commandUrl = 'http://<192.160.1.5>/16/off'; // 控制設備關閉
  } else if (message === '2' || message === 'c') {
    commandUrl = 'http://<192.160.1.5>/17/on'; // 控制設備打開
  } else if (message === '3' || message === 'd') {
    commandUrl = 'http://<192.160.1.5>/17/off'; // 控制設備關閉
  }
